...
if __name__ == "__main__":
    Portfolio(
        ...
        [
            dt.datetime(year=2024, month=5, day=13),
            dt.datetime(year=2024, month=5, day=14),
            dt.datetime(year=2024, month=5, day=15),
            dt.datetime(year=2024, month=5, day=16),
            dt.datetime(year=2024, month=5, day=17),
            dt.datetime(year=2024, month=5, day=20),
            dt.datetime(year=2024, month=5, day=21),
            dt.datetime(year=2024, month=5, day=22),
            dt.datetime(year=2024, month=5, day=23),
            dt.datetime(year=2024, month=5, day=24),
